...
All defined test cases (CM1–CM6) were executed successfully, and the observed behaviour of the system matched the expected outputs in all scenarios.

The testing results confirm that the movement system:
- responds correctly to different input conditions,
- handles simultaneous inputs consistently,
- maintains stable behaviour under sustained thrust, and
- correctly enforces boundary rules such as screen wrapping.

Overall, the Controls and Movement functionality behaves reliably and meets the expected design requirements under the tested conditions.
