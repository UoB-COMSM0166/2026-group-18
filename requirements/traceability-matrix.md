...
| R-11 | US-5.1 Time-Based Level Advancement | AC-5.1 | `#30`, `#70` | `TBD` | `87448db`, `TBD` | `docs/src/systems/level-spawn.js` | `level transition correctness`, `time-based progression consistency across FPS` | confirmed + inferred | Implemented + Enhancement in progress |
